...
window.onload = function () {
    ...
    tinymce.init({
        ...
        plugins: 'preview searchreplace autolink code visualblocks visualchars fullscreen image link media codesample table charmap pagebreak nonbreaking anchor insertdatetime lists wordcount charmap quickbars emoticons accordion',
        license_key: 'gpl',
        promotion: false,
